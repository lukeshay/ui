...
export type Demo = { name: string; styles: [Style<"default">, Style<"new-york">] };
		...
		styles: [
			{
				...
				content: `import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@lshay/ui/components/default/accordion";
...
`,
			...
			},
			{
				...
				content: `import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from "@lshay/ui/components/new-york/accordion";
...
import { Alert, AlertDescription, AlertTitle } from "@lshay/ui/components/new-york/alert";
		...
		styles: [
			{
				...
				content: `import { Avatar, AvatarFallback, AvatarImage } from "@lshay/ui/components/default/avatar";
...
`,
			...
			},
			{
				...
				content: `import { Avatar, AvatarFallback, AvatarImage } from "@lshay/ui/components/new-york/avatar";
